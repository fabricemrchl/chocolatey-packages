...
$packageArgs = @{
  ...
  url64bit      = 'https://github.com/FreeTubeApp/FreeTube/releases/download/v0.25.1-beta/freetube-0.25.1-beta-setup-x64.exe'
  ...
  checksum64    = '601f3608832369d78369e6fd601fadae2b988af5a418d0634cde7c4db942674e'
