...
$url64      = 'https://github.com/adityapk00/zecwallet-lite/releases/download/v1.0.3/Windows-installer-zecwallet-lite-v1.0.3.msi' # 64bit URL here (HTTPS preferred) or remove - if installer contains both (very rare), use $url
